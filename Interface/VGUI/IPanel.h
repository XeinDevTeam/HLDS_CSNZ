...
namespace vgui
{
	...
	public:
		...
		virtual void* GetScheme( IPanel* vguiPanel ) = 0;
		...
		virtual void Solve5(IPanel* vguiPanel) = 0; // вызывается много раз
		virtual void Solve6(IPanel* vguiPanel) = 0; // вызывается много раз
